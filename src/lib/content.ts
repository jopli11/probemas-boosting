...
export const testimonials = [
  {
    source: "Reviews.io",
    rating: 4.9,
    text: "Great service, got it in minutes. Smooth communication and fast delivery.",
    author: "Sean Matthew",
    tag: "OSRS Gold",
  },
  {
    source: "Trustpilot",
    rating: 5.0,
    text: "Super professional team. They kept me updated during the whole order.",
    author: "Alisha Perez",
    tag: "Questing",
  },
  {
    source: "Reviews.io",
    rating: 4.8,
    text: "Highly recommend. Safe, reliable, and the support was outstanding.",
    author: "Daniel K.",
    tag: "Skilling",
  },
  {
    source: "Trustpilot",
    rating: 5.0,
    text: "Fast cape, friendly runner, zero issues. Will order again.",
    author: "Jared L.",
    tag: "Infernal",
  },
];
